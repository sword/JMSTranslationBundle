...
class ExtractorManagerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testRecursive()
    {
        ...
        $manager->setEnabledExtractors(array('foo' => true));
        $manager->setDirectories(array(__DIR__.'/../../Functional/TestBundle/Resources/views'));
        ...
        $this->assertEquals(array(__DIR__.'/../../Functional/TestBundle/Resources/views'),
                $directoriesProperty->getValue($manager));

        $manager->setDirectories(array(__DIR__.'/../../Functional/TestBundle/Resources/views'), true);
        $this->assertEquals(
                array(__DIR__.'/../../Functional/TestBundle/Resources/views', 
                      __DIR__.'/../../Functional/TestBundle/Resources/views/Apple'),
                $directoriesProperty->getValue($manager));
    }
